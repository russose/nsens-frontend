...
const CardKnowGridPublicFollowedKnowbooks_D = dynamic(
  () =>
    import(
      "../../../src/components/ContentCardKnowGridPublicFollowedKnowbooks"
    ),
  {
    ssr: false,
  }
...
const KnowbooksSaved: React.FunctionComponent<IPage> = (props) => {
  ...
  const title = GUI_CONFIG.language.SEO.title_description.KnowbooksSaved.title;
  ...
  return (
    <>
      <AppLayout paramsPage={props.paramsPage}>
        ...
        <CardKnowGridPublicFollowedKnowbooks_D stores={stores} />
      </AppLayout>
    </>
  );
};
...
export default observer(KnowbooksSaved);
