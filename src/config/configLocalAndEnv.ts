...
export const configGeneral = {
  ...
  colors: {
    ...
    network_node_color_css: "whitesmoke",
    network_item_selected_color: "infoWeak",
  },
  staticKnowbooks: {
...
export const configFetching = {
  // userAgent: "nSens/1.0 (https://www.nsens.org; " + getEmail() + ")",
...
export const CUSTOM_ICONS = {
  ...
  HISTORY:
    "M 10.666667,0 H 7.5500001 C 6.4208334,0 5.4125,0.7125 5.0375001,1.775 L 0.12916667,15.633333 C 0.04583333,15.875 0,16.133333 0,16.391667 c 0,1.254166 1.0208333,2.275 2.275,2.275 h 8.391667 V 16 c 0,-0.7375 0.595833,-1.333333 1.333333,-1.333333 0.7375,0 1.333333,0.595833 1.333333,1.333333 v 2.666667 H 21.725 c 1.258333,0 2.275,-1.020834 2.275,-2.275 C 24,16.133333 23.95417,15.875 23.870833,15.633333 L 18.9625,1.775 C 18.583333,0.7125 17.579167,0 16.45,0 H 13.333333 V 2.666667 C 13.333333,3.404167 12.7375,4 12,4 11.2625,4 10.666667,3.404167 10.666667,2.666667 Z m 2.666666,8 v 2.666667 C 13.333333,11.404167 12.7375,12 12,12 11.2625,12 10.666667,11.404167 10.666667,10.666667 V 8 C 10.666667,7.2625 11.2625,6.666667 12,6.666667 12.7375,6.666667 13.333333,7.2625 13.333333,8 Z",
};
